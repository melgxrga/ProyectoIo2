  ...
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          subtitle="Preguntas frecuentes sobre Ecoboya"
          title="Preguntas frecuentes sobre Ecoboya"
          paragraph="Resuelve tus dudas sobre Ecoboya, su fabricación, aplicaciones y beneficios para el medio ambiente."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="¿Cuáles son los materiales utilizados para fabricar Ecoboya?"
              answer="Ecoboya está fabricada con PLA reciclado, un bioplástico seguro, renovable y biodegradable."
            />
            <SingleFaq
              question="¿Cuáles son las aplicaciones más comunes de Ecoboya?"
              answer="Ecoboya se utiliza comúnmente en la señalización de espacios públicos, eventos y ferias."
            />
            <SingleFaq
              question="¿Cuál es la durabilidad de Ecoboya?"
              answer="Ecoboya es resistente a la intemperie y puede durar varios años sin perder su forma ni su color."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="¿Cuál es el impacto ambiental de Ecoboya?"
              answer="Ecoboya es un producto ecológico y biodegradable, lo que reduce su impacto ambiental en comparación con otros materiales."
            />
            <SingleFaq
              question="¿Se puede personalizar Ecoboya?"
              answer="Sí, Ecoboya puede adaptarse en tamaño, color y señalización según las necesidades de cada proyecto."
            />
            <SingleFaq
              question="¿Dónde se puede instalar Ecoboya?"
              answer="Ecoboya se puede instalar en una variedad de lugares, incluyendo espacios públicos, eventos y ferias."
            />
          </div>
        </div>
      </div>
