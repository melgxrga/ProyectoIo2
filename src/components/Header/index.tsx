              ...
              <div>
                ...
                >
                  <ul className="block lg:ml-8 lg:flex lg:gap-x-8 xl:ml-14 xl:gap-x-12">
                    {menuData
                      .filter((menuItem) => menuItem.title !== "Blog" && menuItem.title !== "Pages" && menuItem.title !== "Sign In" && menuItem.title !== "Sign Up")
                      .map((menuItem, index) =>
                        menuItem.path ? (
                          <li key={index} className="group relative">
                            {pathUrl !== "/" ? (
                              ...
                              >
                                {menuItem.title === "Home" ? "Inicio" : menuItem.title === "About" ? "Nosotros" : menuItem.title === "Pricing" ? "Precios" : menuItem.title === "Contact" ? "Contacto" : menuItem.title}
                              </Link>
                            ) : (
                              <Link
                                scroll={false}
